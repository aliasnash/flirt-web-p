	...
	<form class="form" role="form" method="post">
		<div class="row">
			...
			<div class="form-group col-md-4 col-md-offset-4 col-xs-12">
				<label for="nick" class="control-label">Имя:</label> <input type="text" maxlength="11" class="input-md form-control" id="nick" name="nick"
					placeholder="Имя..." value="<?=$profile['nickname'];?>" />
			</div>

			<div class="form-group col-md-4 col-md-offset-4 col-xs-12">
				<label for="my_sex" class="control-label">Пол:</label> <select class="selectpicker form-control input-sm" id="my_sex" title="Выберите пол" data-size="15">
			...
			<div class="form-group col-md-1 col-md-offset-4 col-xs-4 no-right-spaces">
				<label for="bday" class="control-label">День:</label> <select class="selectpicker form-control input-sm" id="bday" title="День" data-size="15">
    					<?php for($i = 1; $i <= 31; $i++) {?>
			...
			<div class="form-group col-md-2 col-xs-4 no-right-spaces no-left-spaces">
				<label for="bmonth" class="control-label">Месяц:</label> <select class="selectpicker form-control input-sm" id="bmonth" title="Месяц" data-size="15">
			...
			<div class="form-group col-md-1 col-xs-4 no-left-spaces">
				<label for="byear" class="control-label">Год:</label> <select class="selectpicker form-control input-sm" id="byear" title="Год" data-size="15">
			...
			<div class="form-group col-md-4 col-md-offset-4 col-xs-12">
				<label for="idcity" class="control-label">Город:</label> <select class="selectpicker form-control input-sm " id="idcity" title="Выберите город"
					data-size="15">
		...
		<div class="row">
			<div class="form-group col-md-12 col-xs-12 text-center">
				...
				<div class="btn-group">
					<a href="<?=WEB_APP?>/profile" class="btn btn-warning btn-sm"> <i class="fa fa-ban fa-lg"></i> Отменить
					</a>
				</div>
			</div>
		</div>
